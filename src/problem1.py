...
def run_test_problem1a():
    ...
    # Test 3:
    expected = 0.044  # This is APPROXIMATELY the correct answer.
    answer = problem1a(6, 66)
    print()
    print('Test 3 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 4:
    expected = -0.965  # This is APPROXIMATELY the correct answer.
...
def run_test_problem1b():
    ...
    print("The number of integers in Test #1 is ", answer, ".")
    #Test 2
    answer = problem1b(6, 66)
    print("The number of integers in Test #2 is ", answer, ".")
    #Test 3
    answer = problem1b(4, 20)
    print("The number of integers in Test #3 is ", answer, ".")
    #Test 4
    answer = problem1b(13, 37)
    print("The number of integers in Test #4 is ", answer, ".")
